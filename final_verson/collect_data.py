# collect_data.py - Bolt vs NUT data collection (webcam version)
                ...
                for cnt in contours:
                    if MIN_AREA < cv2.contourArea(cnt) < MAX_AREA:
                        ...
                        if feats:
                            ...
                            samples_collected.append(feats)
                            added += 1
                print(f"Added {added} NUT samples.")
            else:
                print("!! Capture background first (b) !!")
